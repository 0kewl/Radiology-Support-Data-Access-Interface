...
Route::get('hashtagSuggest', array('as' => 'hashtagSuggest', 'uses' => 'SolrController@getHashtagSuggestions'));
...
// Delete hashtag
Route::post('delete-hashtag', array('as' => 'delete-hashtag', 'uses' => 'SolrController@postDeleteHashtag'));
