...
DROP TABLE IF EXISTS `case_hashtags`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `case_hashtags` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
LOCK TABLES `case_hashtags` WRITE;
/*!40000 ALTER TABLE `case_hashtags` DISABLE KEYS */;
/*!40000 ALTER TABLE `case_hashtags` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-12-05  1:42:53
